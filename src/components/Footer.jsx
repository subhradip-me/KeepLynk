      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-8 md:mb-0">
            ...
            <p className="text-zinc-600 font-light">
              AI-powered content organization platform
            </p>
          </div>
          
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex space-x-6">
              <a href="#" className="text-zinc-600 hover:text-zinc-900 transition-colors duration-300 text-sm font-light">
                Privacy Policy
              </a>
              <a href="#" className="text-zinc-600 hover:text-zinc-900 transition-colors duration-300 text-sm font-light">
                Terms of Service
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-zinc-400 hover:text-zinc-600 transition-colors duration-300">
        ...
        <div className="mt-12 pt-8 border-t border-zinc-200 text-center">
          <p className="text-zinc-500 text-sm font-light">
            © 2025 KeepLynk. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
